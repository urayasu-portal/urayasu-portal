...
逆方向は**ステーションデリバリー**。チェックアウト後にホテルで荷物を預け（**受付は7:00〜12:30**）、駅に向かう途中で**ウェルカムセンター1階のお渡しカウンター**（約**13:00〜21:00**）で受け取れます。**有料・1個800円**——ディズニーホテル各館・[ヒルトン東京ベイ](/travel-guide/hotels/hilton-tokyo-bay/)・[シェラトン](/travel-guide/hotels/sheraton-grande-tokyo-bay/)・[ファーストリゾート](/travel-guide/hotels/maihama-hotel-first-resort/)・[舞浜ビューホテル](/travel-guide/hotels/maihama-view-hotel/)が800円を明示しています。金額非公開のホテルもあるためベルデスクでご確認を。
