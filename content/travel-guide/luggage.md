...
|---|---|---|
| **駅→ホテル**（到着日） | **無料**（ウェルカムセンターのホテルサービスカウンター） | **有料 約{{< fact "bon_voyage.fee" >}}/個**（ボン・ヴォヤッジュ1階カウンター） |
...
**パートナーホテル**などの宿泊者は、JR舞浜駅前**「ボン・ヴォヤッジュ」1階のホームデリバリーサービスカウンター**を利用します：**1個約{{< fact "bon_voyage.fee" >}}**・受付は開店〜**15:00頃**・駅→ホテルの片道です。[ホテルエミオン東京ベイ](/travel-guide/hotels/emion-tokyo-bay/)や[浦安ブライトンホテル東京ベイ](/travel-guide/hotels/brighton-tokyo-bay/)などが対象です。
