...
checkDate: "July 2026"
sources:
  - name: "Tokyo Metropolitan Park Association – Kasai Rinkai Park"
    url: "https://www.tokyo-park.or.jp/park/kasairinkai/index.html"
  - name: "Tokyo Zoo Net – Tokyo Sea Life Park"
...
{{< note >}}
Technically the park is in Edogawa, Tokyo, not Urayasu — but it's the next station from Maihama, so from any Urayasu or Maihama hotel it might as well be local. [Hotel Seaside Edogawa](/en/travel-guide/hotels/hotel-seaside-edogawa/), covered on this site, sits right inside the park.
{{< /note >}}
...
{{< warn >}}
**The aquarium closes on Wednesdays** (or the following day if Wednesday is a national holiday), and the Ferris wheel also takes most of its days off on Wednesdays. The park itself stays open, but if your rest day falls on a Wednesday, both headline attractions may be closed.
{{< /warn >}}
...
1. From **Maihama Station**, take the **JR Keiyo Line** one stop toward Tokyo to **Kasairinkaikoen Station** — about 3 minutes.
2. The park is **directly in front of the station**. Walk toward the Ferris wheel and you can't get lost; the aquarium is about 5 minutes on foot.
...
Locals often make it a double-header: a half day here, then [Urayasu Traffic Park](/en/travel-guide/urayasu-traffic-park/) (free, in Shin-Urayasu). On a rainy day, ride the Keiyo Line a little further to [teamLab Planets in Toyosu](/en/travel-guide/teamlab-planets/) for an indoor plan B.
