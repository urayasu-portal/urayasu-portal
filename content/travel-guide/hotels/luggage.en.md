...
tgNav: true
faq:
  - q: "Can I store my luggage before check-in at Tokyo Disney Resort hotels?"
    a: "Yes. Almost every hotel near the parks will hold your bags before the standard 15:00 check-in — at the bell desk or front desk, and at some hotels in free guest lockers (for example Hotel Dream Gate Maihama and HOTEL MYSTAYS Maihama). Disney Hotels such as Disney Ambassador Hotel accept same-day storage from as early as 6:00. Storage is normally free; confirm size or item limits with your hotel."
  - q: "Is there a free service to send my luggage from the station to my hotel?"
    a: "Yes, for Disney Hotels and the Official Hotels. At the Tokyo Disney Resort Welcome Center next to JR Maihama Station, the Hotel Service Counter delivers your bags to the hotel for free — Disney Hotels on the 2nd floor (about 7:30–16:00) and Official Hotels on the 1st floor (about 8:00–15:00). Partner and independent hotels instead use the paid 'Bon Voyage' home-delivery counter (about ¥800 per item, until around 15:00)."
  - q: "Can I have my bags delivered from the parks to my hotel?"
    a: "No. The Maihama luggage services run between JR Maihama Station and the hotels, not from inside Tokyo Disneyland or DisneySea. Plan to carry what you need into the park, or use in-park lockers and your hotel's front desk."
...
## The Maihama luggage hub: JR Maihama Station

Most of the area's baggage services run through **JR Maihama Station**, the gateway station for the parks. Just outside the south exit is the **Tokyo Disney Resort Welcome Center**, and the Disney store **"Bon Voyage"** next to the station houses a home-delivery counter. What you pay — and whether it's even offered — depends on the direction and your hotel category.
...
<i class="ti ti-alert-triangle" aria-hidden="true"></i> <strong>About luggage information:</strong> Counters, hours and fees change and vary by hotel category. Confirm the current details on your hotel's official website — and note that price/size limits for before-check-in storage are often not published, so ask when you book.
</div>
