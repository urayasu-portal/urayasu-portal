...
tgNav: true
faq:
  - q: "도쿄 디즈니 주변 호텔은 체크인 전에 짐을 맡길 수 있나요?"
    a: "거의 모든 호텔이 15:00 체크인 전에도 프런트나 벨데스크에서 당일 보관에 응합니다. 호텔 드림게이트 마이하마, 호텔 마이스테이즈 마이하마처럼 투숙객 전용 무료 로커를 갖춘 호텔도 있습니다. 디즈니 호텔은 당일 6:00부터 보관 가능. 크기·개수 조건은 호텔에 확인하세요."
  - q: "마이하마역에서 호텔로 짐을 무료로 보낼 수 있나요?"
    a: "디즈니 호텔·공식 호텔 투숙객은 가능합니다. JR 마이하마역 옆 도쿄 디즈니 리조트 웰컴 센터의 호텔 서비스 카운터(디즈니 호텔 2층 약 7:30–16:00／공식 호텔 1층 약 8:00–15:00)에 맡기면 무료로 호텔까지 배송됩니다. 파트너 호텔 등은 역 앞 Bon Voyage 1층의 유료 카운터(약 800엔/개, 15:00경까지)를 이용합니다."
  - q: "파크에서 호텔로 짐을 보낼 수 있나요?"
    a: "보낼 수 없습니다. 마이하마의 수하물 서비스는 JR 마이하마역과 호텔 사이에서만 운영되며, 디즈니랜드·디즈니씨 파크 내에서의 배송은 없습니다. 파크 내 코인 로커나 호텔 프런트 보관을 활용하세요."
...
<i class="ti ti-luggage" aria-hidden="true"></i> <strong>이 페이지는 '마이하마역부터'의 이야기입니다:</strong> 하네다·나리타 공항이나 도쿄역에서 호텔로 짐만 먼저 보내고 싶다면 <strong><a href="/ko/travel-guide/luggage-airport/">하네다·나리타 공항에서 마이하마·우라야스 호텔로 짐 보내는 법</a></strong>을 참고하세요. 당일 배송 마감은 터미널에 따라 아침 9:50~오후 2시로 이르며, 맞출 수 있는지에 따라 취해야 할 수단이 달라집니다.
</div>

---

## 마이하마의 수하물 허브: JR 마이하마역

이 지역 수하물 서비스의 대부분은 **JR 마이하마역**을 거점으로 움직입니다. 남쪽 출구 바로 앞의 **도쿄 디즈니 리조트 웰컴 센터**와, 역 앞 디즈니 스토어 **"Bon Voyage"** 1층의 배송 카운터가 접수처입니다. 요금 유무는 "방향×호텔 구분"으로 결정됩니다.
...
역에서 짐을 맡기고 곧장 파크로——공식 호텔 등급의 숨은 특전입니다.

> 주의: **셀러브레이션 호텔**은 디즈니 호텔 중 유일한 예외로, 이 무료 카운터도 스테이션 딜리버리도 이용할 수 없습니다. 대신 역 앞 **Bon Voyage 유료 카운터**를 이용합니다(요금은 공식 미공개·현지 확인). 웰컴 센터 자체에 짐만 맡기는 일시 보관도 불가하며, 파크 내에서의 배송도 없습니다.
...
- **디즈니 호텔 각 관** — 당일 **6:00**부터 벨데스크/게스트 서비스에서 보관·수령은 당일 24시까지
- **[퍼스트 리조트](/ko/travel-guide/hotels/maihama-hotel-first-resort/)** — 투숙객 전용 무료 로커(7:00–22:00)
- **[호시노 리조트 1955 도쿄 베이](/ko/travel-guide/hotels/hoshinoresorts-1955-tokyo-bay/)** — 전후 이용 가능한 무료 로커
- **[컴포트 스위트 도쿄 베이](/ko/travel-guide/hotels/comfort-suites-tokyo-bay/)** — 전후 무료 셀프 클로크
- **[오리엔탈 호텔 도쿄 베이](/ko/travel-guide/hotels/oriental-tokyo-bay/)** — 투숙객 전용 수하물룸＋2층 벨데스크 보관

---

<div class="tg-notice-info">
<i class="ti ti-alert-triangle" aria-hidden="true"></i> <strong>수하물 정보에 대하여:</strong> 카운터 위치·접수 시간·요금은 호텔 구분에 따라 다르며 변경될 수 있습니다. 체크인 전 보관의 요금·크기 제한은 미공개인 호텔이 많으므로 예약 시 확인하세요.
</div>

## 관련 페이지

- [마이하마역에서 호텔로 짐을 보내는 방법(당일 이용 순서)](/ko/travel-guide/luggage-howto/)
- [하네다·나리타 공항에서 마이하마·우라야스 호텔로 짐 보내는 법](/ko/travel-guide/luggage-airport/)
