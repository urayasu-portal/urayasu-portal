...
{{< note >}}
teamLab has more than one permanent museum in Tokyo. The one near Maihama is **Planets in Toyosu** (Borderless is across town in Azabudai). Planets is the only one where you enter the water. A 2025 expansion added new zones with more physical, playful exhibits, making it noticeably more family-friendly.
{{< /note >}}
...
{{< warn >}}
**Clothing decides your experience.** The water reaches your knees, so wear pants you can roll up or shorts (free shorts rental available). Some floors are mirrored, so skirts are a poor choice (rentals available too). You'll be barefoot, so skip the stockings. Lockers and towels are provided.
{{< /warn >}}
...
1. From **Maihama Station**, take the **JR Keiyo Line** two stops toward Tokyo to **Shin-Kiba** — about 8 minutes.
2. Transfer to the **Tokyo Metro Yurakucho Line** for two stops to **Toyosu** — about 5 minutes.
3. Walk **about 10 minutes**, or hop on the Yurikamome line for one stop to **Shin-Toyosu**, which is right at the entrance.
...
Toyosu is home to **Toyosu Market**, with a food-and-hot-spring complex next door, and LaLaport Toyosu (a kid-friendly mall) nearby — you can chain a whole rainy day indoors. The local finishing move: get off at Maihama on the way back and soak at the [Maihama Eurasia hot spring](/en/travel-guide/maihama-eurasia-spa/).
